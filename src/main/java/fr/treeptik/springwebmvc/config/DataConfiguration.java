...
@EnableJpaRepositories(basePackages = "fr.treeptik.springwebmvc.dao", entityManagerFactoryRef = "entityManagerFactory")
public class DataConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
		...
		localContainerEntityManagerFactoryBean.setPackagesToScan("fr.treeptik.springwebsample.model");
